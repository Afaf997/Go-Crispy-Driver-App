                        ...
                        ? Center(
                            child: Padding(
                              ...
                              child: SizedBox(
                                ...
                                child: CustomButton(
                                  btnTxt:
                                      getTranslated('Branch location', context),
                                  onTap: () async {
                                    try {
                                      Position position =
                                                ...
                                                builder:
                                                  ...
                                                  return AlertDialog(
                                                    title: Text(getTranslated(
                                                        'success', context)!),
                                                    content: const Text(
                                                        "Successfully picked the order"),
                                                    actions: <Widget>[
                                                      TextButton(
                                                        onPressed: () async {
                                                          setState(() {
                                                            _isPickedUp =
                                                                true; // Update the state to mark as picked up
                                                          });
                                                              ...
                                                              MaterialPageRoute(
                                                                  builder: (_) =>
                                                                      OrderDetailsScreen(
                                                                        orderModelItem:
                                                                            orderModel,
                                                                        isAlreadyCollectedOrNot: _isPickedUp
                                                                            ? true
                                                                            : false,
                                                                        isNavigate:
                                                                            true,
